          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if (textEditingController.text.isEmpty || (imageFile == null && imageBytes == null)) {
                    ...
                    try {
                      ...
                      // Prepare parts: include text and image bytes if available.
                      ...
                      setState(() {
                        strAnswer = response.text.toString();
                      });
                    } catch (e) {
                      // Show a friendly message and include the raw error for debugging.
                      final msg = e.toString();
                      setState(() {
                        visibleSP = true;
                        strAnswer = 'Error calling Gemini API:\n\n'
                            '$msg\n\nPlease check the model name and API version.\nCall ListModels to see available models and supported methods.';
                      });
                    }
                  }
                },
